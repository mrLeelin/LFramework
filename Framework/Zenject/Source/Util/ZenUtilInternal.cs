...
namespace Zenject.Internal
{
    public static class ZenUtilInternal
    {
        ...
        private static readonly Dictionary<Type,bool> ExitNotInjectValidationAttribute = new Dictionary<Type, bool>();
        ...
        public static bool IsExitNotInjectAttribute(Type t)
        {
            if ( t == null)
            {
                return true;
            ...
            return GetNotInjectAttributeExist(t);
        }
        
    

        private static bool GetNotInjectAttributeExist(Type type)
        {
            if (ExitNotInjectValidationAttribute.TryGetValue(type,out var res))
            {
                return res;
            }
            
            res = type.GetCustomAttribute<NotInjectAttribute>(true) != null;
            ExitNotInjectValidationAttribute.Add(type,res);
            return res;
        }
