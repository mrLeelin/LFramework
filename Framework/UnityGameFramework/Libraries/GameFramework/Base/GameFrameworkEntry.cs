...
namespace GameFramework
{
    ...
    public static class GameFrameworkEntry
    {
        ...
        public static T GetModule<T>() where T : class
        {
            ...
            var implementorAttribute = interfaceType.GetCustomAttribute<ManagerImplementorAttribute>();
            string moduleName;
            if (implementorAttribute == null)
            {
                moduleName = Utility.Text.Format("{0}.{1}", interfaceType.Namespace, interfaceType.Name.Substring(1));
            }
            else
            {
