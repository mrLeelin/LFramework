...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        /// Ui的Root节点
        /// </summary>
        public Transform CanvasRoot => m_InstanceRoot.Find("UiInstanceRoot");
        ...
        public override void StartComponent()
        {
            ...
            {
                m_InstanceRoot = Object.Instantiate(m_InstanceRoot, Instance);
                m_InstanceRoot.name = "[UI Form Instances]";
                m_InstanceRoot.transform.position = Vector3.zero;
            }

            _canvasScaler = m_InstanceRoot.GetComponentInChildren<CanvasScaler>();
            m_InstanceRoot.gameObject.layer = LayerMask.NameToLayer("UI");
            m_InstanceRoot.transform.position = m_InstanceRootOffset;
            CanvasRootSizeDelta = CanvasRoot.GetComponent<RectTransform>();
        ...
        public override void LateUpdate()
        {
            if (_canvasScaler)
            {
                _canvasScaler.matchWidthOrHeight =  (Screen.width / (float)Screen.height) < 0.5625f ? 0 : 1;
            }
        }
        ...
        {
            return (IUIForm)m_UIManager.GetUIForm(uiFormAssetName);
        }
