...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        public override void StartComponent()
        {
            ...
            if (m_EditorResourceMode && m_ResourceMode != ResourceMode.Addressable)
            {
                return;
            }
        ...
        {
            InstantiateAsset(assetName, priority, loadAssetCallbacks, null);
        }
        /// <summary>
        /// 实例化资源
        /// </summary>
        ...
        public void InstantiateAsset(string assetName, int priority, LoadAssetCallbacks loadAssetCallbacks,object userData)
        {
            ...
            m_ResourceManager.InstantiateAsset(assetName, priority, loadAssetCallbacks,userData);
        }
