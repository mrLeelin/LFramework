        ...
        private sealed class EnvironmentInformationWindow : ScrollableDebuggerWindowBase
        {
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    //DrawItem("Resource Version", m_BaseComponent.EditorResourceMode ? "Unavailable in editor resource mode" : (string.IsNullOrEmpty("") ? "Unknown" : Utility.Text.Format("{0} ({1})", m_ResourceComponent, m_ResourceComponent.InternalResourceVersion)));
