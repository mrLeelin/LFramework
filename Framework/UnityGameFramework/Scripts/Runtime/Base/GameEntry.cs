...
namespace UnityGameFramework.Runtime
{
    ...
    public static class GameEntry
    {
        ...
        internal static T GetComponent<T>() where T : GameFrameworkComponent
        {
            return (T)GetComponent(typeof(T));
        }

        internal static GameFrameworkLinkedList<GameFrameworkComponent> GetAllComponent()
        {
            Debug.Assert(s_GameFrameworkComponents!=null,"Framework component is null ");
        ...
        /// <returns>要获取的游戏框架组件。</returns>
        internal static GameFrameworkComponent GetComponent(Type type)
        {
        ...
        /// <returns>要获取的游戏框架组件。</returns>
        internal static GameFrameworkComponent GetComponent(string typeName)
        {
            LinkedListNode<GameFrameworkComponent> current = s_GameFrameworkComponents.First;
            while (current != null)
            {
