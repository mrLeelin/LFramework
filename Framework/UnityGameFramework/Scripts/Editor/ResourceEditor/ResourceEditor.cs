...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    internal sealed partial class ResourceEditor : EditorWindow
    {
        ...
        {
            if (GUILayout.Button("Add", GUILayout.Width(65f)) ||( Event.current.isKey && Event.current.keyCode == KeyCode.A))
            {
            ...
            {
                if (GUILayout.Button("Rename", GUILayout.Width(65f))||( Event.current.isKey && Event.current.keyCode == KeyCode.S))
                {
                ...
                if (GUILayout.Button("Remove", GUILayout.Width(65f))||( Event.current.isKey && Event.current.keyCode == KeyCode.D))
                {
        ...
        private void DrawResourcesMenu_Remove()
        {
            ...
            if (GUILayout.Button("Yes", GUILayout.Width(50f))||( Event.current.isKey && Event.current.keyCode == KeyCode.D))
            {
