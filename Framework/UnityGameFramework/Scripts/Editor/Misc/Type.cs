...
namespace UnityGameFramework.Editor
{
    ...
    public class Type
    {
        ...
        public static System.Type[] GetRuntimeOrEditorTypes(System.Type typeBase)
        {
            return GetTypes(typeBase, RuntimeOrEditorAssemblyNames);
        }

        public static string[] GetTypeNames(System.Type typeBase, params string[] assemblyNames)
        {
        ...
        public static System.Type[] GetTypes(System.Type typeBase,params string[] assemblyNames)
        {
