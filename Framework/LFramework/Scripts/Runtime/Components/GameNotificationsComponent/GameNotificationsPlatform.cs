...
namespace LFramework.Runtime
{
    ...
    public class GameNotificationsPlatform : IDisposable
    {
        ...
        /// <summary>
        ///  The component that is used to manage the notifications.
        /// </summary>
        private readonly GameNotificationsComponent _component;
        ...
        /// </summary>
        public GameNotificationsPlatform(NotificationCenterArgs args,GameNotificationsComponent component)
        {
        ...
        {
            return new GameNotification(_component);
        }
        ...
        public GameNotification GetLastNotification()
        {
            ...
            {
                return new GameNotification(notification.Value,_component);
            }
        ...
        private void OnLocalNotificationReceived(Notification notification)
        {
            ...
            NotificationReceived?.Invoke(new GameNotification(notification,_component));
        }
    }
