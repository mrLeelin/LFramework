...
namespace LFramework.Runtime
{
    public sealed class TableComponent : GameFrameworkComponent
    {
        ...
        public override void StartComponent()
        {
            ...
            {
                _tableManager.SetResourceManager(BaseComponent.EditorResourceHelper);
            }
            else
            {
        ...
        {
            EventComponent.Fire(this, LoadDataTableSuccessEventArgs.Create(e));
        }
        ...
        private void OnReadDataFailure(object sender, ReadDataFailureEventArgs e)
        {
            Log.Warning("Load data table failure, asset name '{0}', error message '{1}'.", e.DataAssetName,
                e.ErrorMessage);
            EventComponent.Fire(this, LoadDataTableFailureEventArgs.Create(e));
        }

        private void OnReadDataUpdate(object sender, ReadDataUpdateEventArgs e)
        {
            EventComponent.Fire(this, LoadDataTableUpdateEventArgs.Create(e));
        }

        private void OnReadDataDependencyAsset(object sender, ReadDataDependencyAssetEventArgs e)
        {
            EventComponent.Fire(this, LoadDataTableDependencyAssetEventArgs.Create(e));
        }
    }
}