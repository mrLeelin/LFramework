...
namespace LFramework.Runtime
{
    public partial class SpriteCollectionComponent
    {
        ...
        private void InitializedResources()
        {
            ...
            _eventComponent = LFrameworkAspect.Instance.Get<EventComponent>();
        }
        ...
        private void OnLoadAssetSuccess(string assetName, object asset, float duration, object userdata)
        {
            ...
            if (userdata is string userdataStr)
            {
                m_SpriteCollectionPool.Register(
                    SpriteCollectionItemObject.Create(userdataStr, collection, m_ResourceComponent), false);

                _eventComponent.Fire(this, LoadSpriteCollectionCompleted.Create(userdataStr));
                return;
            }
            ...
            _eventComponent.Fire(this, LoadSpriteCollectionCompleted.Create(setSpriteObject.CollectionPath));
        }
        ...
        public void SetSprite(ISetSpriteObject setSpriteObject)
        {
            ...
            if (m_WaitSetObjects.TryGetValue(setSpriteObject.CollectionPath, out var o))
            {
                o.AddLast(setSpriteObject);
            }
            else
            {
        ...
        public async UniTask SetSpriteAsync(ISetSpriteObject setSpriteObject)
        {
            ...
            if (m_SpriteCollectionBeingLoaded.Contains(setSpriteObject.CollectionPath))
            {
                while (m_SpriteCollectionBeingLoaded.Contains(setSpriteObject.CollectionPath))
                {
                    await UniTask.Yield();
                }
