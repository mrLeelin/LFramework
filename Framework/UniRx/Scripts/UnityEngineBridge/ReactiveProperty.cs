...
namespace UniRx
{
    ...
    public static class ReactivePropertyExtensions
    {
        ...
        public static IDisposable BindTo<T>(this IReactiveProperty<T> source, UnityEngine.Events.UnityEvent<T> unityEvent)
        {
            var d2 = unityEvent.AsObservable().SubscribeWithState(source, (x, c) => c.Value = x);
            return d2;
        }
        ...
        /// </summary>
        public static IDisposable BindTo<T>(this IReactiveProperty<T> source, IObservable<T> observable)
        {
           return observable.Subscribe(x => source.Value = x);
        }
